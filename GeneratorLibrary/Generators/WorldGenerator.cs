...
namespace GeneratorLibrary.Generators
{
    public class WorldGenerator
    {
        ...
        public World GenerateWorld()
        {
            ...
            {
                Mass = AtmosphereTables.GenerateMass(world.Type.Size, world.Type.SubType, roll1),
            ...
            {
                Coverage = HydrographicCoverageTables.GenerateHydrographicCoverage(world.Type.Size, world.Type.SubType, _diceRoller),
            ...
            Climate climate = new()
            {
                ...
                Kelvin = Math.Round(ClimateTables.GenerateAverageSurfaceTemperatureInKelvinsByWorldType(world.Type.Size, world.Type.SubType, roll1), 0)
            };
            ...
            if (world.Type.Size is not WorldSize.Special)
            {
                ...
                {
                    Density = Math.Round(CharacteristicsTables.GenerateWorldDensity(world.Type.Size, world.Type.SubType, roll1), 2)
                };
                roll1 = _diceRoller.Roll(2, -2);
                characteristics.Diameter =
                    Math.Round(CharacteristicsTables.GenerateWorldDiameter(world.Type.Size, world.Climate.BlackBodyTemperature, characteristics.Density, roll1), 2);
            ...
            roll1 = _diceRoller.Roll(1);
            roll2 = _diceRoller.Roll(1);
            ...
            switch (world.SettlementData.Type)
            {
                ...
                case SettlementType.Outpost:
                    ...
                    double variationFactor = _random.NextDouble() * 0.5 - 0.25;
                    population.CurrentPopulation = PopulationTables.GenerateOutpostPopulation(roll1, variationFactor);
                    break;
                default:
                    break;
            }
            ...
            if (world.SettlementData.Type is not SettlementType.Uninhabited)
            {
                ...
                if (society.Unity == WorldUnity.WorldGovernment_Special)
                {
                    roll1 = _diceRoller.Roll(3);
                    roll2 = _diceRoller.Roll(1);
                    int hasTwoSpecialSocieties = _diceRoller.Roll(1);
                ...
                if (world.Society is not null)
                {
                    ...
                    roll1 = _diceRoller.Roll();
                    roll2 = _diceRoller.Roll();
                    int[] rolls = [roll1, roll2, _diceRoller.Roll(), _diceRoller.Roll(), _diceRoller.Roll()];
                    ...
                    if (world.Population.PopulationRating > 0)
                        installations.Facilities = InstallationsTables.GenerateFacilities(
                            world.Population.PopulationRating,
                            world.ControlRating.CR,
                            world.TechLevel.TL,
                            installations.Spaceports,
                            _diceRoller);
